...
public class Harbor extends ProductionBuilding {
    ...
    private void createUnitsUnlockedAtLevelList() {
        super.setUnitsUnlockedAtLevel(new ArrayList<>(Arrays.asList(
                new Unlock(UnitType.TransportShip, 1)
        )));
    }
...
//        super.setConstructionTimeSeconds((long) (250 + 100 * Math.pow(super.getLevel(), 1.2)));
