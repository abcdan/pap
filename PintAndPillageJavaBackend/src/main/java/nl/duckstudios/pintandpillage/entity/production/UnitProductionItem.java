...
public class UnitProductionItem {
    ...
    @Getter @Setter
    private long secondsToProduce;

    @Getter @Setter
    private long totalSecondsToProduce;

    @Getter @Setter
    private LocalTime timeToProduce;

    @Getter @Setter
    private LocalTime totalTimeToProduce;
    ...
    @Getter @Setter
    private int startAmountToProduce;
