<template>
    <div id="app">
      <div v-if="isMobile != true">
          <game-header @showModal="showModal($event)" v-if="this.$route.path === '/' || this.$route.path === '/world'"></game-header>
      </div>
      <div v-else>
          <game-header-mobile @showModal="showModal($event)" v-if="this.$route.path === '/' || this.$route.path === '/world'"></game-header-mobile>
      </div>
    ...
    export default {
        ...
        methods:{
            ...
            updateTimers(obj) {
                ...
                let propNames = ['constructionTimeLeft', 'totalTimeToProduce', 'researchTimeLeft', 'travelTimeLeft'];
                for (let prop in obj) {
            ...
            convertSecondsToTime: function (prop, seconds) {
                ...
                let formattedString = hrs.toString().padStart(2, '0') + ":" + mnts.toString().padStart(2, '0') + ":" + seconds.toString().padStart(2, '0');
