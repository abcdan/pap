        ...
        methods:{
            getTileSource: function () {
                ...
                if (this.seasonsOn && this.currentSeason === 'winter'){
                    if (this.isLevelTen()){
                        return require('../../assets/winterTiles/smith.png')
                    }
                    return require('../../assets/tiles/level_10/winter/smith_10.png')
                }else{
                    if (this.isLevelTen()){
                        return require('../../assets/tiles/smith.png')
                    }
                    return require('../../assets/tiles/level_10/smith_10.png')
                }
            },
            isLevelTen: function () {
